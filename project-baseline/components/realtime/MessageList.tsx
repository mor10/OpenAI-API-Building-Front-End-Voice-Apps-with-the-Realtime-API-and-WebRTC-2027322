...
import type { DisplayMessage, MessageListProps } from "@/types/realtime";
  ...
  return history.map((item, index) => {
    ...
    if (item.type === "message") {
      ...
      const containsBanned =
        item.role === "assistant" && text.toLowerCase().includes(BANNED_PHRASE);
...
export function MessageList({
  ...
  /**
   * Omit the initial greeting message request from the display
   */
